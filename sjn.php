					...
					<div id="page-bgbtm">
						...
						<div id="sidebar">
							<ul>
								<li>
									<h2>O algoritmu</h2>
									<p>SJN stoji kao akronim za shortest job next. Jednostavan algoritam koji predviđa vrijeme trajanja obrade procesa i na temelju toga 
									dodjeljuje procesorsko vrijeme. Onaj proces u ready queue koji ima najmanje predviđeno vrijeme obrade dobiva prvi na raspolaganje procesor.
									Također je poznat i pod Shortest job first (SJF) i Shortest process next (SPN).</p>
								</li>
								<li>
