					...
					<div id="page-bgbtm">
						...
						<div id="sidebar">
							<ul>
								<li>
									<h2>O algoritmu</h2>
									<p> Raspodjela procesorskog vremena po prioritetu je osnovni i najjednostavniji algoritam odlučivanja. Postoji više varijanata i većinom se koriste u 
									kombinaciji sa ostalim algoritmima raspodjele procesorskog vremena. Ovdje je prikazan najjednostavniji tip, proces koji dobije procesorsko vrijeme izvršava se
									do kraja, a nakon njega se iz ready queue uzima idući proces sa najvećim prioritetom (niži broj označava veći prioritet).</p>
								</li>
								<li>
